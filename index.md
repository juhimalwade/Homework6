...
- The [`as.numeric()`](https://rdrr.io/r/base/numeric.html) method
  reconstructs the full vector with zeros in appropriate positions

### Visualization

The [`plot()`](https://rdrr.io/r/graphics/plot.default.html) method
allows visual comparison of two sparse vectors. It displays the non-zero
positions and values for both vectors on a single plot, using different
colors to distinguish between them. This is useful for understanding the
structure and overlap of sparse data.
